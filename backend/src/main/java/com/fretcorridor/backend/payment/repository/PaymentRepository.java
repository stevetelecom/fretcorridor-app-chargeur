...
public interface PaymentRepository extends JpaRepository<Payment, UUID> {
    ...
    // Sans filtre userId : utilisee par ShipmentTrackingService (contexte
    // admin, recordDeliveryProof) pour liberer le sequestre.
    Optional<Payment> findByShipmentRequestId(UUID shipmentRequestId);
}
